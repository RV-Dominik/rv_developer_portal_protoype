        ...
        public async Task<IActionResult> GetManifest(string slug)
        {
            try
            {
                ...
                var manifest = new ManifestDto
                {
                    ...
                    DeveloperName = project.CompanyName ?? "",
                    DeveloperWebsite = project.CompanyWebsite ?? "",
                    Version = project.BuildStatus ?? "",
                    UnityVersion = project.BuildFormat ?? "",
                    UnrealVersion = project.PublishingTrack ?? "",
