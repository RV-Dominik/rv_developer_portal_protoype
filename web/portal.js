/*
NOTE: Deprecated file (not used by the running app)

This legacy dashboard script is no longer served. The deployed site loads assets from
`server/wwwroot`, using the refactored, modular frontend:
 - `server/wwwroot/portal-refactored.js` (entry point)
 - `server/wwwroot/js/core/PortalCore.js`
 - `server/wwwroot/js/projects/ProjectManager.js`
 - `server/wwwroot/js/organization/OrganizationManager.js`
 - `server/wwwroot/js/onboarding/*`

Keep this file only for historical reference. Do NOT edit this file expecting UI changes.
*/
